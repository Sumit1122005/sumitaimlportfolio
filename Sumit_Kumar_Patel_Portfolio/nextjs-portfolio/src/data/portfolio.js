export const portfolioData = {
  ...
  education: [
    ...
    },
    {
      ...
      date: '2022 - 2023',
      institution: 'Govt. Model Higher Senior Secondary School',
      description: 'Completed Class 12th with 79% under the Madhya Pradesh Board of Secondary Education.'
    },
    {
      degree: 'Class X - MPBSE',
      date: '2020 - 2021',
      institution: 'Govt. Model Higher Senior Secondary School',
      description: 'Completed Class 10th with 85% under the Madhya Pradesh Board of Secondary Education.'
    }
  ],
  skills: [
    { name: 'Python', category: 'AI/ML', type: 'Language' },
    { name: 'C++', category: 'Core CS', type: 'Language' },
    { name: 'Kotlin', category: 'Frontend', type: 'Language' },
    { name: 'SQL', category: 'Backend', type: 'Language' },
    { name: 'JavaScript', category: 'Frontend', type: 'Language' },
    { name: 'HTML5 & CSS3', category: 'Frontend', type: 'Language' },
    { name: 'React.js', category: 'Frontend', type: 'Framework' },
    { name: 'Next.js', category: 'Frontend', type: 'Framework' },
    { name: 'Machine Learning', category: 'AI/ML', type: 'Concept' },
    { name: 'Deep Learning', category: 'AI/ML', type: 'Concept' },
    { name: 'NLP', category: 'AI/ML', type: 'Concept' },
    { name: 'Generative AI', category: 'AI/ML', type: 'Concept' },
    { name: 'RAG', category: 'AI/ML', type: 'Concept' },
    { name: 'MLOps', category: 'AI/ML', type: 'Concept' },
    { name: 'Scikit-learn', category: 'AI/ML', type: 'Library' },
    { name: 'PyTorch', category: 'AI/ML', type: 'Library' },
    { name: 'TensorFlow', category: 'AI/ML', type: 'Library' },
    { name: 'Pandas', category: 'AI/ML', type: 'Library' },
    { name: 'NumPy', category: 'AI/ML', type: 'Library' },
    { name: 'Seaborn', category: 'AI/ML', type: 'Library' },
    { name: 'Matplotlib', category: 'AI/ML', type: 'Library' },
    { name: 'Plotly', category: 'AI/ML', type: 'Library' },
    { name: 'LangChain', category: 'AI/ML', type: 'Library' },
    { name: 'LLM', category: 'AI/ML', type: 'Concept' },
    { name: 'FastAPI', category: 'Backend', type: 'Framework' },
    { name: 'REST API', category: 'Backend', type: 'Concept' },
    { name: 'Docker Deployment', category: 'Backend', type: 'Tool' },
    { name: 'Vector Database', category: 'Backend', type: 'Concept' },
    { name: 'Pinecone', category: 'Backend', type: 'Database' },
    { name: 'n8n', category: 'Automation', type: 'Tool' },
    { name: 'Make', category: 'Automation', type: 'Tool' },
    { name: 'Git & GitHub', category: 'Tools & Design', type: 'Tool' },
    { name: 'VS Code', category: 'Tools & Design', type: 'Tool' },
    { name: 'Tailwind CSS', category: 'Tools & Design', type: 'Tool' },
    { name: 'Canva', category: 'Tools & Design', type: 'Tool' },
    { name: 'Figma', category: 'Tools & Design', type: 'Tool' },
    { name: 'Data Structures', category: 'Core CS', type: 'Concept' },
    { name: 'DBMS', category: 'Core CS', type: 'Concept' },
    { name: 'Operating Systems', category: 'Core CS', type: 'Concept' }
  ],
  projects: [
    {
